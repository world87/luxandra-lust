...
{
    public class IncidentWorker_WetDreamsPulseMechCluster : IncidentWorker
    {
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            GameConditionDef conditionDef = DefDatabase<GameConditionDef>.GetNamed("Luxandra_WetDreamsFertilityPulse", false);
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            ThingDef transmitterDef = DefDatabase<ThingDef>.GetNamed("Luxandra_WetDreamsPulseTransmitter", false);
